    ...
    return (
        <main className="min-h-screen p-12">
            <section className="container mx-auto">
                <h1 className="text-5xl flex justify-center cursive defaultFontColor">My Projects Page</h1>
                <h2 className="text-lg defaultFontColor flex justify-center mb-12">Here is what I have been recently working on...</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {postData && postData.map((post, index) => (
                    <article>
                        <Link to={"/"} key={index}>
                            <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-pink-700">
                                <img src={imagePlaceholder1} className="w-full h-full rounded-r object-fit absolute"></img>
